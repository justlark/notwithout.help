...
<template>
  <main aria-labelledby="main-heading" class="flex flex-col items-center">
    <h1 id="main-heading" class="text-center mb-8">Tips</h1>
    <div class="text-justify max-w-3xl">
      <p>
        Not Without Help is free to use, forever. This site will <strong>never</strong> run ads or
        sponsored content.
      </p>
      <p>
